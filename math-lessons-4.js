  ...
  sections: [
    {
      ...
      content: '<p><strong>BIDMAS</strong> is the rule that tells everyone in the world how to evaluate the same expression and get the same answer. Without it, 3 + 4 × 2 could mean 14 or 11 — and both would seem "correct".</p><svg width="100%" height="70" viewBox="0 0 420 70" style="max-width:420px;display:block;margin:0.75em 0"><rect x="0"   y="5" width="55" height="60" rx="6" fill="#e3f2fd"/><rect x="65"  y="5" width="55" height="60" rx="6" fill="#e8f5e9"/><rect x="130" y="5" width="115" height="60" rx="6" fill="#fff3e0"/><rect x="255" y="5" width="155" height="60" rx="6" fill="#f3e5f5"/><text x="27"  y="32" text-anchor="middle" font-size="14" font-weight="bold" fill="#1565c0">B</text><text x="27"  y="52" text-anchor="middle" font-size="9"  fill="#1565c0">Brackets</text><text x="92"  y="32" text-anchor="middle" font-size="14" font-weight="bold" fill="#2e7d32">I</text><text x="92"  y="52" text-anchor="middle" font-size="9"  fill="#2e7d32">Indices</text><text x="187" y="32" text-anchor="middle" font-size="14" font-weight="bold" fill="#e65100">D M</text><text x="187" y="52" text-anchor="middle" font-size="9"  fill="#e65100">Divide &amp; Multiply</text><text x="332" y="32" text-anchor="middle" font-size="14" font-weight="bold" fill="#6a1b9a">A S</text><text x="332" y="52" text-anchor="middle" font-size="9"  fill="#6a1b9a">Add &amp; Subtract</text></svg><p>Division/Multiplication and Addition/Subtraction are done <strong>left to right</strong> when they appear at the same level — they have equal priority within their pair.</p>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<p>A <strong>rational number</strong> is any number that can be expressed as a fraction p/q, where p and q are integers and q ≠ 0. This is a very large set — it includes whole numbers, fractions, terminating decimals, and recurring decimals.</p><svg width="100%" height="90" viewBox="0 0 380 90" style="max-width:380px;display:block;margin:0.75em 0"><rect x="0" y="5" width="380" height="80" rx="8" fill="#e8f5e9"/><text x="190" y="24" text-anchor="middle" font-size="11" font-weight="bold" fill="#2e7d32">Rational Numbers</text><rect x="10" y="30" width="80" height="42" rx="5" fill="#c8e6c9"/><rect x="100" y="30" width="80" height="42" rx="5" fill="#c8e6c9"/><rect x="190" y="30" width="80" height="42" rx="5" fill="#c8e6c9"/><rect x="280" y="30" width="90" height="42" rx="5" fill="#c8e6c9"/><text x="50" y="54" text-anchor="middle" font-size="10" fill="#2e7d32">Whole numbers</text><text x="140" y="54" text-anchor="middle" font-size="10" fill="#2e7d32">Fractions</text><text x="230" y="48" text-anchor="middle" font-size="10" fill="#2e7d32">Terminating</text><text x="230" y="61" text-anchor="middle" font-size="10" fill="#2e7d32">decimals</text><text x="325" y="48" text-anchor="middle" font-size="10" fill="#2e7d32">Recurring</text><text x="325" y="61" text-anchor="middle" font-size="10" fill="#2e7d32">decimals</text></svg><p>Numbers like π and √2 are <strong>irrational</strong> — their decimal expansions go on forever without repeating, and cannot be written as an exact fraction.</p>'
    },
    {
      heading: 'Plotting on a Number Line',
      content: '<p>To plot a rational number: convert to a decimal if needed, identify which two integers it sits between, then mark its position proportionally.</p><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.75em 0"><strong>Example: Plot −¾ = −0.75</strong><br>It sits between −1 and 0, three-quarters of the way from 0 towards −1.<svg width="100%" height="50" viewBox="0 0 300 50" style="max-width:300px;display:block;margin:0.5em 0"><line x1="20" y1="25" x2="280" y2="25" stroke="#555" stroke-width="1.5"/><line x1="20"  y1="20" x2="20"  y2="30" stroke="#555"/><text x="20"  y="42" text-anchor="middle" font-size="11">−1</text><line x1="150" y1="20" x2="150" y2="30" stroke="#555"/><text x="150" y="42" text-anchor="middle" font-size="11">0</text><line x1="280" y1="20" x2="280" y2="30" stroke="#555"/><text x="280" y="42" text-anchor="middle" font-size="11">1</text><circle cx="85" cy="25" r="5" fill="#c62828"/><text x="85" y="14" text-anchor="middle" font-size="10" fill="#c62828">−¾</text></svg></div>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<p>The biggest reason students get word problems wrong is rushing past the reading. Take your time at the start — it saves time overall.</p><svg width="100%" height="80" viewBox="0 0 420 80" style="max-width:420px;display:block;margin:0.75em 0"><rect x="0"   y="10" width="70" height="60" rx="6" fill="#e3f2fd"/><rect x="90"  y="10" width="70" height="60" rx="6" fill="#e8f5e9"/><rect x="180" y="10" width="70" height="60" rx="6" fill="#fff3e0"/><rect x="270" y="10" width="70" height="60" rx="6" fill="#f3e5f5"/><rect x="360" y="10" width="55" height="60" rx="6" fill="#e0f7fa"/><text x="35"  y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#1565c0">1. Read</text><text x="35"  y="54" text-anchor="middle" font-size="9"  fill="#1565c0">Twice if needed</text><text x="125" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#2e7d32">2. Identify</text><text x="125" y="54" text-anchor="middle" font-size="9"  fill="#2e7d32">Key info</text><text x="215" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#e65100">3. Choose</text><text x="215" y="54" text-anchor="middle" font-size="9"  fill="#e65100">Operations</text><text x="305" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#6a1b9a">4. Calculate</text><text x="305" y="54" text-anchor="middle" font-size="9"  fill="#6a1b9a">Step by step</text><text x="387" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#00695c">5. Check</text><text x="387" y="54" text-anchor="middle" font-size="9"  fill="#00695c">Makes sense?</text></svg>'
    },
    {
      heading: 'Worked Examples',
    ...
    },
    {
      ...
      content: '<p>Some problems give the <em>final result</em> and ask for the starting value. Work backwards by reversing each step in reverse order.</p><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.75em 0"><strong>Example:</strong> Sam thinks of a number, doubles it, adds 6, and gets 18. What is the number?<svg width="100%" height="55" viewBox="0 0 380 55" style="max-width:380px;display:block;margin:0.5em 0"><rect x="0"   y="10" width="55" height="30" rx="5" fill="#e3f2fd"/><text x="27"  y="29" text-anchor="middle" font-size="12" fill="#1565c0" font-weight="bold">n</text><text x="65"  y="29" font-size="11" fill="#555">×2</text><rect x="90"  y="10" width="55" height="30" rx="5" fill="#e8f5e9"/><text x="117" y="29" text-anchor="middle" font-size="12" fill="#2e7d32" font-weight="bold">2n</text><text x="155" y="29" font-size="11" fill="#555">+6</text><rect x="180" y="10" width="80" height="30" rx="5" fill="#fff3e0"/><text x="220" y="29" text-anchor="middle" font-size="12" fill="#e65100" font-weight="bold">2n+6 = 18</text><text x="290" y="17" font-size="10" fill="#c62828">−6</text><text x="290" y="32" font-size="10" fill="#c62828">→ 2n = 12</text><text x="290" y="47" font-size="10" fill="#c62828">→ n = 6</text></svg></div>'
    }
  ]
},
