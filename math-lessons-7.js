...
'mi-26-1': {
  ...
  sections: [
    ...
    },
    {
      ...
      content: '<p>These two families of shapes are often confused. The key difference is how many bases they have and what happens between them.</p><svg width="100%" height="100" viewBox="0 0 380 100" style="max-width:380px;display:block;margin:0.75em 0"><rect x="0"   y="5" width="180" height="90" rx="8" fill="#e3f2fd"/><rect x="200" y="5" width="180" height="90" rx="8" fill="#e8f5e9"/><text x="90"  y="25" text-anchor="middle" font-size="13" font-weight="bold" fill="#1565c0">Prism</text><text x="290" y="25" text-anchor="middle" font-size="13" font-weight="bold" fill="#2e7d32">Pyramid</text><text x="90"  y="44" text-anchor="middle" font-size="11" fill="#1565c0">2 identical parallel bases</text><text x="290" y="44" text-anchor="middle" font-size="11" fill="#2e7d32">1 polygonal base</text><text x="90"  y="62" text-anchor="middle" font-size="11" fill="#1565c0">Rectangular faces between</text><text x="290" y="62" text-anchor="middle" font-size="11" fill="#2e7d32">Triangular faces meet at apex</text><text x="90"  y="80" text-anchor="middle" font-size="11" fill="#555">e.g. triangular prism</text><text x="290" y="80" text-anchor="middle" font-size="11" fill="#555">e.g. square pyramid</text></svg><p>Both are named after their base shape: a <em>hexagonal prism</em> has a hexagonal base; a <em>pentagonal pyramid</em> has a pentagonal base.</p>'
    }
  ]
},
  ...
  sections: [
    {
      ...
      content: '<p>A <strong>net</strong> is the flat 2D pattern that can be folded up to form a 3D shape — like unboxing a cardboard shape and flattening it out. Every face of the 3D shape appears exactly once in the net.</p><p>Nets are useful for: understanding the faces of a 3D shape, calculating surface area, and making physical 3D models.</p><svg width="100%" height="155" viewBox="0 0 350 155" style="max-width:350px;display:block;margin:0.75em auto"><rect x="20"  y="50" width="40" height="40" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><rect x="60"  y="50" width="40" height="40" fill="#bbdefb" stroke="#1565c0" stroke-width="1.5"/><rect x="100" y="50" width="40" height="40" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><rect x="60"  y="10" width="40" height="40" fill="#bbdefb" stroke="#1565c0" stroke-width="1.5"/><rect x="60"  y="90" width="40" height="40" fill="#bbdefb" stroke="#1565c0" stroke-width="1.5"/><rect x="140" y="50" width="40" height="40" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><text x="90"  y="146" text-anchor="middle" font-size="10" fill="#1565c0">One valid net of a cube</text><text x="260" y="30"  text-anchor="middle" font-size="11" fill="#555">Fold up along</text><text x="260" y="46"  text-anchor="middle" font-size="11" fill="#555">the dashed lines</text><text x="260" y="62"  text-anchor="middle" font-size="11" fill="#555">→ cube forms</text><text x="260" y="100" text-anchor="middle" font-size="22" fill="#1565c0">⬛</text></svg>'
    },
    {
      heading: 'Common Nets',
  ...
  sections: [
    {
      ...
      content: '<p>Engineers and architects describe 3D shapes using three standard 2D views — together they give a complete description of a shape on flat paper.</p><svg width="100%" height="90" viewBox="0 0 380 90" style="max-width:380px;display:block;margin:0.75em 0"><rect x="0"   y="10" width="115" height="70" rx="8" fill="#e3f2fd"/><rect x="130" y="10" width="115" height="70" rx="8" fill="#e8f5e9"/><rect x="260" y="10" width="115" height="70" rx="8" fill="#fff3e0"/><text x="57"  y="32" text-anchor="middle" font-size="12" font-weight="bold" fill="#1565c0">Plan view</text><text x="187" y="32" text-anchor="middle" font-size="12" font-weight="bold" fill="#2e7d32">Front elevation</text><text x="317" y="32" text-anchor="middle" font-size="12" font-weight="bold" fill="#e65100">Side elevation</text><text x="57"  y="52" text-anchor="middle" font-size="10" fill="#1565c0">Looking directly</text><text x="187" y="52" text-anchor="middle" font-size="10" fill="#2e7d32">Looking directly</text><text x="317" y="52" text-anchor="middle" font-size="10" fill="#e65100">Looking directly</text><text x="57"  y="68" text-anchor="middle" font-size="10" fill="#1565c0">DOWN from above</text><text x="187" y="68" text-anchor="middle" font-size="10" fill="#2e7d32">from the FRONT</text><text x="317" y="68" text-anchor="middle" font-size="10" fill="#e65100">from the SIDE</text></svg><p>These three views together are called an <strong>orthographic projection</strong> — the standard drawing method used by architects and engineers worldwide.</p>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<table style="border-collapse:collapse;width:100%;margin:0.75em 0;font-size:0.9em"><tr style="background:#e8f5e9"><th style="border:1px solid #ccc;padding:8px">Shape</th><th style="border:1px solid #ccc;padding:8px">Area formula</th><th style="border:1px solid #ccc;padding:8px">Perimeter</th></tr><tr><td style="border:1px solid #ccc;padding:8px">Rectangle (l × w)</td><td style="border:1px solid #ccc;padding:8px"><strong>A = l × w</strong></td><td style="border:1px solid #ccc;padding:8px">2(l + w)</td></tr><tr style="background:#f9f9f9"><td style="border:1px solid #ccc;padding:8px">Square (side s)</td><td style="border:1px solid #ccc;padding:8px"><strong>A = s²</strong></td><td style="border:1px solid #ccc;padding:8px">4s</td></tr><tr><td style="border:1px solid #ccc;padding:8px">Triangle</td><td style="border:1px solid #ccc;padding:8px"><strong>A = ½ × base × height</strong></td><td style="border:1px solid #ccc;padding:8px">Sum of all sides</td></tr><tr style="background:#f9f9f9"><td style="border:1px solid #ccc;padding:8px">Parallelogram</td><td style="border:1px solid #ccc;padding:8px"><strong>A = base × height</strong></td><td style="border:1px solid #ccc;padding:8px">2(a + b)</td></tr></table><svg width="100%" height="75" viewBox="0 0 380 75" style="max-width:380px;display:block;margin:0.5em 0"><polygon points="30,65 130,65 130,15 30,15" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><text x="80" y="45" text-anchor="middle" font-size="11" fill="#1565c0">Rectangle</text><text x="80" y="72" text-anchor="middle" font-size="10" fill="#555">l × w</text><polygon points="160,65 240,65 220,20 180,20" fill="#e8f5e9" stroke="#2e7d32" stroke-width="1.5"/><line x1="200" y1="20" x2="200" y2="65" stroke="#2e7d32" stroke-width="1" stroke-dasharray="3,3"/><text x="200" y="72" text-anchor="middle" font-size="10" fill="#555">½ × b × h</text><text x="207" y="45" font-size="9" fill="#2e7d32">h</text><polygon points="270,65 350,65 370,20 290,20" fill="#fff3e0" stroke="#e65100" stroke-width="1.5"/><line x1="320" y1="20" x2="320" y2="65" stroke="#e65100" stroke-width="1" stroke-dasharray="3,3"/><text x="315" y="72" text-anchor="middle" font-size="10" fill="#555">b × h</text><text x="325" y="45" font-size="9" fill="#e65100">h</text></svg>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<p>A <strong>trapezium</strong> has exactly one pair of parallel sides, labelled <em>a</em> (shorter) and <em>b</em> (longer), with a perpendicular height <em>h</em> between them.</p><svg width="100%" height="110" viewBox="0 0 300 110" style="max-width:300px;display:block;margin:0.75em auto"><polygon points="60,20 220,20 260,90 20,90" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><line x1="150" y1="20" x2="150" y2="90" stroke="#1565c0" stroke-width="1.5" stroke-dasharray="4,3"/><text x="140" y="58" font-size="11" fill="#1565c0">h</text><text x="140" y="16" font-size="11" text-anchor="middle" fill="#1565c0">a</text><text x="140" y="103" font-size="11" text-anchor="middle" fill="#1565c0">b</text><rect x="146" y="20" width="8" height="8" fill="none" stroke="#1565c0" stroke-width="1"/><text x="240" y="55" font-size="13" fill="#333" font-weight="bold">A = ½(a+b)h</text></svg><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.5em 0"><strong>Example:</strong> Parallel sides 6 cm and 10 cm, height 4 cm.<br>A = ½(6 + 10) × 4 = ½ × 16 × 4 = <strong>32 cm²</strong></div><p><strong>Why this formula works:</strong> A trapezium is the average of two rectangles — one with width a and one with width b, both of height h. The "½(a + b)" is that average width.</p>'
    },
    {
      heading: 'Compound Figures',
      content: '<p>A <strong>compound figure</strong> is a shape built from two or more standard shapes joined together. Split it, calculate each part separately, then combine.</p><svg width="100%" height="130" viewBox="0 0 300 130" style="max-width:300px;display:block;margin:0.75em auto"><rect x="20"  y="20"  width="120" height="80" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5" stroke-dasharray="4,3"/><rect x="140" y="60"  width="80"  height="40" fill="#e8f5e9" stroke="#2e7d32" stroke-width="1.5" stroke-dasharray="4,3"/><polygon points="20,20 140,20 140,100 220,100 220,60 140,60 140,20" fill="none" stroke="#333" stroke-width="2"/><text x="80"  y="65" text-anchor="middle" font-size="12" fill="#1565c0" font-weight="bold">Part A</text><text x="180" y="85" text-anchor="middle" font-size="12" fill="#2e7d32" font-weight="bold">Part B</text><text x="80"  y="80" text-anchor="middle" font-size="10" fill="#1565c0">120 × 80 = 9,600</text><text x="180" y="120" text-anchor="middle" font-size="10" fill="#2e7d32">80 × 40 = 3,200</text><text x="150" y="125" text-anchor="middle" font-size="11" fill="#333" font-weight="bold">Total = 12,800 mm²</text></svg><p><strong>Method:</strong> (1) Split the shape into rectangles, triangles or other standard shapes. (2) Find each area. (3) Add them together — or subtract if a piece is cut away.</p>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<p><strong>Volume</strong> measures the amount of space a 3D shape occupies. For cuboids and cubes, it is simply the product of the three dimensions.</p><svg width="100%" height="110" viewBox="0 0 300 110" style="max-width:300px;display:block;margin:0.75em auto"><polygon points="40,80 120,80 120,30 40,30" fill="#e3f2fd" stroke="#1565c0" stroke-width="1.5"/><polygon points="120,30 160,10 160,60 120,80" fill="#bbdefb" stroke="#1565c0" stroke-width="1.5"/><polygon points="40,30 80,10 160,10 120,30" fill="#90caf9" stroke="#1565c0" stroke-width="1.5"/><line x1="40" y1="80" x2="40" y2="30" stroke="#1565c0" stroke-width="1.5"/><text x="25" y="58" font-size="11" fill="#1565c0">h</text><text x="76" y="93" font-size="11" fill="#1565c0">length</text><text x="143" y="42" font-size="11" fill="#1565c0">w</text><text x="190" y="50" font-size="14" fill="#333" font-weight="bold">V = l × w × h</text><text x="190" y="70" font-size="12" fill="#555">e.g. 6 × 4 × 3 = 72 cm³</text></svg><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.5em 0"><strong>Cube with side s:</strong> V = s³ &nbsp;&nbsp;|&nbsp;&nbsp; s = 5 cm: V = 5³ = <strong>125 cm³</strong><br>Volume is always in <strong>cubic units</strong>: cm³, m³, mm³</div>'
    },
    {
  ...
  sections: [
    {
      ...
      content: '<p>A <strong>budget</strong> is a plan that sets out expected income and spending. Understanding the balance between the two is the foundation of all personal and business finance.</p><svg width="100%" height="90" viewBox="0 0 380 90" style="max-width:380px;display:block;margin:0.75em 0"><rect x="0"   y="10" width="170" height="70" rx="8" fill="#e8f5e9"/><rect x="210" y="10" width="170" height="70" rx="8" fill="#fce4ec"/><text x="85"  y="32" text-anchor="middle" font-size="13" font-weight="bold" fill="#2e7d32">Income</text><text x="295" y="32" text-anchor="middle" font-size="13" font-weight="bold" fill="#c62828">Expenditure</text><text x="85"  y="52" text-anchor="middle" font-size="10" fill="#2e7d32">wages · allowances</text><text x="295" y="52" text-anchor="middle" font-size="10" fill="#c62828">rent · food · bills</text><text x="85"  y="68" text-anchor="middle" font-size="10" fill="#2e7d32">benefits · investments</text><text x="295" y="68" text-anchor="middle" font-size="10" fill="#c62828">transport · entertainment</text></svg><p style="background:#e8f5e9;padding:0.5em 1em;border-radius:6px;text-align:center"><strong>Balance = Income − Expenditure</strong></p><div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin:0.75em 0;text-align:center;font-size:0.9em"><div style="background:#e8f5e9;padding:8px;border-radius:8px"><strong style="color:#2e7d32">Surplus</strong><br>Income &gt; Spending<br>Money left over</div><div style="background:#e3f2fd;padding:8px;border-radius:8px"><strong style="color:#1565c0">Balanced</strong><br>Income = Spending<br>Nothing left</div><div style="background:#fce4ec;padding:8px;border-radius:8px"><strong style="color:#c62828">Deficit</strong><br>Spending &gt; Income<br>Going into debt</div></div>'
    },
    {
