...
Reward SPECIFIC, accurate historical detail (names, dates, events). Generic assertion without evidence stays in the lower levels. Credit a clear line of argument and a supported judgement.`,
  "english-literature": `SUBJECT: GCSE English Literature (AQA), a 30-mark essay question. The exact task varies — read the QUESTION to see which it is:
- Extract-based (Shakespeare or the 19th-century novel): "Starting with this extract, explore how the writer presents [X]" — the student must write about BOTH the printed extract AND the whole text.
- Whole-text essay (modern text, e.g. a 20th-century play): no extract — the student ranges across the whole text to answer the question.
- Poetry comparison (the anthology): "Compare how poets present [X] in [named poem] and one other poem" — reward perceptive COMPARISON of two poems' ideas and methods. (Anthology poems may be under copyright, so the student need not quote a second poem at length — credit accurate reference to its ideas and methods.)
