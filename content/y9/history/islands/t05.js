// content/y9/history/islands/t05.js — Year 9 History Topic 5: Decolonisation & the Modern World
// Islands h9i-05-1 .. h9i-05-2. Authored by the atlas-content skill. All original.

FLASHCARDS.push(
  // h9i-05-1 — The End of Empires
  {id:"h9fc-05-1-1", islandId:"h9i-05-1", front:"What is decolonisation?",
   back:"Decolonisation is the process by which colonies gained independence from their European imperial rulers, mainly between 1945 and 1975.\n\nBy 1945, European powers such as Britain, France, Belgium, the Netherlands and Portugal controlled vast territories in Africa, Asia and the Caribbean. Within three decades, most of these colonies had become independent nations.", difficulty:1, category:"definition"},
  {id:"h9fc-05-1-2", islandId:"h9i-05-1", front:"Why did European empires weaken after 1945?",
   back:"Several factors weakened the empires after WWII:\n\n1. European powers were financially and militarily exhausted from the war.\n2. The war exposed the hypocrisy of fighting for freedom abroad while ruling colonies.\n3. The Atlantic Charter (1941) — Roosevelt and Churchill's statement supporting self-determination — raised colonial expectations.\n4. The USA and USSR both opposed old-style colonialism (for different reasons).\n5. Nationalist movements in colonies grew stronger and better organised.", difficulty:2, category:"concept"},
  {id:"h9fc-05-1-3", islandId:"h9i-05-1", front:"How did the Cold War influence decolonisation?",
   back:"Both superpowers used decolonisation to extend their influence:\n\n• The USA supported independence movements to open new markets and gain allies.\n• The USSR backed revolutionary movements to spread communism.\n• Newly independent countries were often caught between the two, with both sides offering aid, weapons and political support.\n\nThis led to proxy wars in countries like Korea, Vietnam and various African nations.", difficulty:2, category:"concept"},
  {id:"h9fc-05-1-4", islandId:"h9i-05-1", front:"What role did the United Nations play in decolonisation?",
   back:"The UN played a significant role:\n\n1. The UN Charter (1945) upheld the principle of self-determination.\n2. The 1960 Declaration on the Granting of Independence to Colonial Countries demanded an end to colonialism.\n3. The UN provided a platform for newly independent nations to have a voice in world affairs.\n4. UN peacekeeping missions helped manage the transition in some regions.\n\nAs colonies gained independence, UN membership grew rapidly — from 51 members in 1945 to over 150 by 1980.", difficulty:2, category:"application"},
  {id:"h9fc-05-1-5", islandId:"h9i-05-1", front:"What were the common patterns of decolonisation?",
   back:"Decolonisation took different forms:\n\n1. Negotiated transfer — some colonies gained independence through talks (e.g. India, Ghana). Often a gradual process with constitutions and elections.\n2. Armed struggle — in other cases, independence came only after violent conflict (e.g. Algeria, Kenya's Mau Mau uprising, Vietnam).\n3. Partition — some territories were divided along ethnic or religious lines (e.g. India/Pakistan, Palestine).\n\nThe method depended on the colonial power's willingness to withdraw and the strength of the independence movement.", difficulty:2, category:"concept"}
);
Object.assign(QUESTIONS, {
  "h9i-05-1": [
    {q:"When did most decolonisation take place?", opts:["Between 1945 and 1975","Between 1900 and 1918","Between 1800 and 1850","After 2000"], c:0,
     e:"The main wave of decolonisation occurred between 1945 and 1975, as European empires lost their grip on colonies in Africa, Asia and the Caribbean."},
    {q:"Which wartime document raised expectations of self-determination among colonial peoples?", opts:["The Atlantic Charter (1941)","The Treaty of Versailles (1919)","The Truman Doctrine (1947)","The Marshall Plan (1948)"], c:0,
     e:"The Atlantic Charter, issued by Roosevelt and Churchill in 1941, declared that people should have the right to choose their own government — raising hopes in the colonies."},
    {q:"How did the Cold War affect newly independent countries?", opts:["Both the USA and USSR competed for their allegiance, sometimes leading to proxy wars","Newly independent countries were ignored by both superpowers","The Cold War had no impact on decolonisation","Newly independent countries always sided with the USA"], c:0,
     e:"Both superpowers tried to win the support of new nations by offering aid, weapons and political backing, sometimes turning local conflicts into proxy wars."},
    {q:"What did the UN Declaration of 1960 demand?", opts:["An end to colonialism and the granting of independence to all colonial peoples","The partition of all remaining colonies","Military intervention against colonial powers","The return of colonies to their original rulers"], c:0,
     e:"The 1960 UN Declaration on the Granting of Independence to Colonial Countries and Peoples called for a speedy end to colonialism in all its forms."},
    {q:"Which of these is an example of decolonisation through armed struggle?", opts:["Algeria","Ghana","India","Australia"], c:0,
     e:"Algeria fought a brutal war of independence against France (1954–62). Ghana and India gained independence through largely negotiated processes."}
  ]
});
Object.assign(LESSONS, {
  "h9i-05-1": `<h2>The End of Empires</h2>
<p>By 1945, European powers controlled vast territories across the globe. Within 30 years, most of these colonies had become independent nations — a process known as <strong>decolonisation</strong>.</p>
<p>Several factors drove the collapse of empires:</p>
<ul>
<li><strong>WWII exhaustion</strong> — European powers were financially and militarily drained.</li>
<li><strong>Changed attitudes</strong> — fighting for freedom while ruling over colonies seemed hypocritical.</li>
<li><strong>Nationalist movements</strong> — educated leaders in the colonies demanded self-rule.</li>
<li><strong>Superpower pressure</strong> — both the USA and USSR opposed traditional European colonialism.</li>
<li><strong>The United Nations</strong> — promoted self-determination and gave new nations a global voice.</li>
</ul>
<h3>Worked example</h3>
<p><strong>Q: Explain two reasons why European empires collapsed after 1945.</strong></p>
<p>One reason was <strong>the economic impact of WWII</strong>. Britain and France were deeply in debt and could no longer afford to maintain large empires and armies overseas. A second reason was <strong>the growth of nationalist movements</strong>. Leaders like Gandhi in India and Nkrumah in Ghana organised mass movements demanding independence, making it politically impossible for colonial powers to hold on.</p>
<h3>Common mistake</h3>
<p>Students often treat decolonisation as a single event. In reality, it was a process that happened at different speeds in different places — some transitions were peaceful, others involved years of armed conflict.</p>`
});

FLASHCARDS.push(
  // h9i-05-2 — Independence Movements
  {id:"h9fc-05-2-1", islandId:"h9i-05-2", front:"How did India gain independence and why was it partitioned?",
   back:"India gained independence from Britain on 15 August 1947, largely due to the non-violent campaigns led by Mahatma Gandhi and the Indian National Congress.\n\nHowever, deep tensions between Hindus and Muslims meant the subcontinent was partitioned into two nations: India (Hindu majority) and Pakistan (Muslim majority). The partition triggered horrific communal violence, killing up to one million people and displacing 10–15 million.", difficulty:2, category:"concept"},
  {id:"h9fc-05-2-2", islandId:"h9i-05-2", front:"Who was Mahatma Gandhi and what methods did he use?",
   back:"Mohandas 'Mahatma' Gandhi was the leader of India's independence movement. He championed non-violent resistance (satyagraha), including:\n\n• The Salt March (1930) — walking 390 km to protest the British salt tax.\n• Boycotts of British goods.\n• Civil disobedience — encouraging Indians to break unjust laws peacefully.\n\nGandhi's methods inspired civil rights movements around the world, including Martin Luther King Jr's campaigns in the USA.", difficulty:2, category:"concept"},
  {id:"h9fc-05-2-3", islandId:"h9i-05-2", front:"How did Ghana become independent?",
   back:"Ghana (formerly the Gold Coast) became the first sub-Saharan African country to gain independence, on 6 March 1957.\n\nKwame Nkrumah led the independence movement using strikes, boycotts and political campaigning. His success inspired other African nations to seek independence.\n\nNkrumah became Ghana's first prime minister and later its president. He championed Pan-Africanism — the idea of African unity and cooperation.", difficulty:2, category:"concept"},
  {id:"h9fc-05-2-4", islandId:"h9i-05-2", front:"What was the Mau Mau uprising in Kenya?",
   back:"The Mau Mau uprising (1952–60) was an armed rebellion by Kenyan fighters (mainly Kikuyu) against British colonial rule. The main grievance was the loss of African land to white settlers.\n\nThe British declared a state of emergency and used brutal methods to suppress the revolt, including detention camps. Thousands of Kenyans died.\n\nAlthough the Mau Mau were militarily defeated, the uprising showed Britain that colonial rule was unsustainable. Kenya gained independence in 1963 under Jomo Kenyatta.", difficulty:2, category:"concept"},
  {id:"h9fc-05-2-5", islandId:"h9i-05-2", front:"What were the lasting effects of decolonisation on former colonies?",
   back:"The legacy of decolonisation is complex:\n\n• Borders drawn by colonial powers often ignored ethnic and tribal divisions, creating lasting conflicts.\n• Many new nations inherited weak institutions and faced economic challenges.\n• Some fell into dictatorships or civil wars.\n• Neo-colonialism — former colonial powers continued to exert economic influence.\n• Cultural impacts — languages, legal systems and education models from the colonial era persist.\n\nHowever, independence also brought national pride, democratic movements and economic development over time.", difficulty:3, category:"application"}
);
Object.assign(QUESTIONS, {
  "h9i-05-2": [
    {q:"When did India gain independence from Britain?", opts:["15 August 1947","26 January 1950","1 January 1948","15 August 1945"], c:0,
     e:"India gained independence on 15 August 1947, though the Republic of India was formally constituted on 26 January 1950."},
    {q:"What was the main consequence of the partition of India?", opts:["Massive communal violence and the displacement of millions of people","A peaceful transition to two democratic nations","The creation of a single united republic","An immediate economic boom for both countries"], c:0,
     e:"Partition triggered terrible Hindu-Muslim violence, killing up to one million people and forcing 10–15 million to flee their homes."},
    {q:"Which was the first sub-Saharan African country to gain independence?", opts:["Ghana (1957)","Kenya (1963)","Nigeria (1960)","South Africa (1994)"], c:0,
     e:"Ghana (formerly the Gold Coast) became independent on 6 March 1957 under the leadership of Kwame Nkrumah, inspiring other African independence movements."},
    {q:"What was the main grievance behind the Mau Mau uprising?", opts:["The loss of African land to white settlers","Disagreement over religious practices","Opposition to new taxation policies","Protest against compulsory education"], c:0,
     e:"The Mau Mau were primarily driven by anger over the seizure of Kikuyu land by white settlers in Kenya's fertile highlands."},
    {q:"What is meant by 'neo-colonialism'?", opts:["Former colonial powers continuing to exert economic and political influence over independent nations","The re-establishment of formal colonial rule","A movement to restore the British Empire","Colonisation of space by former imperial powers"], c:0,
     e:"Neo-colonialism refers to the ongoing economic and political influence that former colonial powers maintain over their ex-colonies, even after formal independence."}
  ]
});
Object.assign(LESSONS, {
  "h9i-05-2": `<h2>Independence Movements</h2>
<p>Independence came in different ways across the globe. Two of the most important case studies are <strong>India</strong> and <strong>Africa</strong>.</p>
<p><strong>India (1947)</strong>: Under the leadership of <strong>Mahatma Gandhi</strong>, the Indian independence movement used non-violent resistance — boycotts, civil disobedience and mass protest — to pressure Britain into leaving. However, Hindu–Muslim tensions led to <strong>partition</strong>: the subcontinent was divided into India and Pakistan, triggering terrible violence and massive population displacement.</p>
<p><strong>Africa</strong>: <strong>Ghana</strong> (1957) was the first sub-Saharan African nation to gain independence, led by Kwame Nkrumah. His success inspired movements across the continent. In <strong>Kenya</strong>, the Mau Mau uprising (1952–60) was violently suppressed by the British, but it demonstrated that colonial rule was unsustainable. Kenya gained independence in 1963.</p>
<p>The <strong>legacy</strong> of decolonisation is mixed: national pride and self-determination, but also artificial borders, economic challenges and ongoing neo-colonial influence.</p>
<h3>Worked example</h3>
<p><strong>Q: Explain the impact of the partition of India in 1947.</strong></p>
<p>The partition divided the subcontinent into <strong>Hindu-majority India</strong> and <strong>Muslim-majority Pakistan</strong>. This triggered massive <strong>communal violence</strong> — Hindus, Muslims and Sikhs attacked each other in horrific massacres. Up to one million people were killed. Around <strong>10–15 million people</strong> were displaced as Hindus fled to India and Muslims fled to Pakistan, making it one of the largest forced migrations in history.</p>
<h3>Common mistake</h3>
