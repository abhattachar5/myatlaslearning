...
'mi-23-1': {
  title: 'Formulae & Two-Variable Equations',
  sections: [
    {
      heading: 'Substituting into a Formula',
      content: '<p>A <strong>formula</strong> is a rule written with letters. To use one, replace each letter with its value and work the arithmetic out carefully — remember BIDMAS, and square before you multiply.</p><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.75em 0"><table style="border-collapse:collapse;width:100%;font-size:0.9em"><tr style="background:#c8e6c9"><th style="padding:7px;border:1px solid #ccc;text-align:left">Formula</th><th style="padding:7px;border:1px solid #ccc;text-align:left">Values</th><th style="padding:7px;border:1px solid #ccc;text-align:left">Working</th></tr><tr><td style="padding:7px;border:1px solid #ccc">F = ma</td><td style="padding:7px;border:1px solid #ccc">m = 8, a = 4</td><td style="padding:7px;border:1px solid #ccc">F = 8 × 4 = <strong>32</strong></td></tr><tr style="background:#f9f9f9"><td style="padding:7px;border:1px solid #ccc">A = πr²</td><td style="padding:7px;border:1px solid #ccc">r = 7, π ≈ 3.14</td><td style="padding:7px;border:1px solid #ccc">A = 3.14 × 7² = 3.14 × 49 = <strong>153.86</strong></td></tr><tr><td style="padding:7px;border:1px solid #ccc">E = ½mv²</td><td style="padding:7px;border:1px solid #ccc">m = 10, v = 6</td><td style="padding:7px;border:1px solid #ccc">E = ½ × 10 × 36 = <strong>180</strong></td></tr></table></div><div style="background:#fce4ec;padding:1em;border-radius:8px;margin:0.75em 0;border-left:4px solid #c62828"><strong>Watch out:</strong> in A = πr², the square applies to r only — square first, then multiply by π. Doing (πr)² instead is the most common slip.</div>'
    },
    {
      heading: 'Function Machines & Changing the Subject',
      content: '<p>A <strong>function machine</strong> applies operations in order. Run it forwards to get the output; run it <em>backwards using inverse operations</em> to get back to the input.</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:0.75em 0"><div style="background:#e8f5e9;padding:10px;border-radius:8px"><strong>Forwards</strong><br>Input 5 → ×2 → +3 → Output<br>5 × 2 = 10, 10 + 3 = <strong>13</strong></div><div style="background:#e3f2fd;padding:10px;border-radius:8px"><strong>Backwards</strong><br>Output 11, rule ×3 then −1<br>Undo: 11 + 1 = 12, 12 ÷ 3 = <strong>4</strong></div></div><p><strong>Changing the subject</strong> is the same idea written algebraically: undo the operations to get the letter you want on its own.</p><div style="background:#f1f8e9;padding:1em;border-radius:8px;margin:0.75em 0">P = 4r → divide both sides by 4 → <strong>r = P/4</strong><br>y = 5x + 3 → subtract 3 → y − 3 = 5x → divide by 5 → <strong>x = (y − 3)/5</strong></div>'
    },
    {
